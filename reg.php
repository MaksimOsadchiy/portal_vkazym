<?php
    ...
    $service = selectALL_main('services');
...
<form class="row justify-content-md-center" method="post" action="reg.php">
    ...
    <div class="mb-3 col-12 col-md-4">
        ...
        <input type="text" name="login" value="<?=$login?>" class="form-control" id="formGroupExampleInput" placeholder="Пример: aa.ivanov">
    </div>
    <div class="w100"></div>
    <div class="mb-3 col-12 col-md-4">
    ...
    <div class="mb-3 col-12 col-md-4">
        ...
        <input type="password" name="first_password" class="form-control" id="exampleInputPassword1" placeholder="Не менее 8-ми символов">
    </div>
    <div class="w100"></div>
    <div class="mb-3 col-12 col-md-4">
        <label for="exampleInputPassword1" class="form-label">Повторите пароль</label>
        <input type="password" name="second_password" class="form-control" id="exampleInputPassword1" placeholder="">
    </div>
    <div class="w100"></div>
    <div class="mb-3 col-12 col-md-4">
