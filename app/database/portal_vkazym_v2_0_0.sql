...
--
-- Хост: localhost
-- Время создания: Авг 05 2024 г., 12:44
...
CREATE TABLE `fittings` (
  ...
  `presence_act` varchar(127) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(6, 'Поволжье', 'ЛК', 853, '930-1', 'АЗТП', '1984', '2545', 300, 6, NULL, NULL, '409', '537 КрУ', 'Шаровой', 80, 'Подземное', '1985', 1),
...
--
-- Структура таблицы `list_workability`
--

CREATE TABLE `list_workability` (
  `id` int NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `malfunctions` (
  `id` int NOT NULL,
  `workability` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `malfunctions` (`id`, `workability`, `tightness`, `leakage`, `act_leakage`, `drainage`, `packing_pipelines`, `result`) VALUES
(6, 'Герметичен', NULL, NULL, NULL, NULL, NULL, 1),
...
--
-- Индексы таблицы `list_workability`
--
ALTER TABLE `list_workability`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `list_workability`
--
ALTER TABLE `list_workability`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
