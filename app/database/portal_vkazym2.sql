...
--
-- Хост: localhost
-- Время создания: Июл 16 2024 г., 12:11
...
(1, 0, 'Обычный пользователь(только просмотр)'),
(2, 1, 'Админ'),
(3, 2, 'Техник 1(Только заказ техники)'),
(4, 3, 'Техник 2(Заказ/подтверждение техники)'),
(5, 4, 'Тех. Поддержка(Просмотр/ответы на заявки)'),
(6, 5, 'Техник 1 - Тех. Поддержка(Заказ/подтверждение техники и просмотр/ответы на заявки)'),
(7, 6, 'Техник 2 - Тех. Поддержка(Заказ/подтверждение техники и просмотр/ответы на заявки)');
...
INSERT INTO `users` (`id`, `login`, `password`, `privilege`, `service_id`) VALUES
(1, 'ii.ivanov', '$2y$10$35.yVnFrsE9VXxcIWyziXuPLTxY8jaPKbc3TthHEQ7.aX8AbCpVky', 0, NULL),
(2, 'ii.ivanov2', '$2y$10$5nMCCX7K/3Smk2UwM6bLROJO64v61wzgFKbnwkVQrqOxpXEKiySgG', 0, NULL),
(3, 'ii.ivanov3', '$2y$10$Abw38N4RumrLRGEkFtz0rOvR0L39D42gCNp6X7sy6M.KZqP43EWnq', 0, NULL),
(4, 'ii.ivanov4', '$2y$10$1HBaOo06MRWeBCMe8BlfzuKuN36AVmzr65f4ZjLVusuAPdSy.ZNUu', 0, NULL),
(5, 'ii.ivanov5', '$2y$10$ph2h/Y77Z9bzxB1ZF2Oy8OplNRmD4nMIBDV64N5s7xJTvvjrcQ1I.', 0, NULL),
(6, 'ii.ivano66', '$2y$10$UgHWB.Flt/nAD7ChK9bP4eDgqMUETpBuQdSQk10Bt7yXlFmkjLYo.', 0, NULL),
(7, 'wqdqd', '$2y$10$K2IS/sL02aTkKg810UGMEeBUKo438Qah2tCTiBs6E7qt1YBWJV8rK', 0, NULL),
(8, 'ii.ivanov7', '$2y$10$VNaMm0xeMOc1YK6Bfobl1OmT35/BPP0e/.Sxo0oDY75GPgl1Xryfy', 0, NULL),
(9, 'ii.ivanov10', '$2y$10$uXxWard7vwbZJW1rc6SEhuDtwsrPDfAyFWiXfQUXb5uGCceIaPm2e', 0, NULL),
(10, 'ii.ivanov11', '$2y$10$d483T/CxMDPUPaOipnpYneEgAGJLQxsyctMW84qmHBhE9fVvhz9rO', 0, NULL),
(11, 'ii.ivanov12', '$2y$10$3dGmTFEQN1G6J4o8oXa21uzt6v7L25eO/4e08ugpZs0c6FsqnP2Uu', 0, NULL),
(12, 'ii.ivanov13', '$2y$10$xKN.tTZDDTHp7JC6hYRUAuo3KHLnif9wGODV40NkSWw2EV81tZS0y', 0, NULL),
(13, 'ii.ivanov14', '$2y$10$KvdehAHAqfEDPC6LD1TgYuDr3YpLd23h2JDunSbU6QIBmz3tbkhHC', 0, NULL),
(14, 'ii.ivanov15', '$2y$10$//AuBTk7bZDrcNNkGyLLZuESbdZYS42BwJPoHvMsUxhwSH/7o6dlu', 0, NULL),
(15, 'ii.ivanov16', '$2y$10$kuIMHOCv9RSIMJVvmc054OTGVDjIorrASiMy2.uG7/xq13oJ5pU7y', 0, NULL),
(16, 'ii.ivanov17', '$2y$10$IbhVNW3tTjOpOOY5H1yRw.GEDYYBI1dSdQQdG6FwZ/CRghyUR8lG2', 0, NULL),
(17, 'ii.ivanov18', '$2y$10$86tevaRXnd0sQO96hTy6BO66Ybr7WV/ObSvfe0JoZgAIgXvBC9yNe', 0, NULL),
(18, 'ii.ivanov19', '$2y$10$w9VJ1cr9W8l6pouc8RoFZekB94is/BP6C88HFQomj9.lz9cOnFVM2', 1, NULL),
(19, 'ii.ivanov22', '$2y$10$OPK8drX3iEm7Z0S0M5aTb.3uyH1DkPY6m8GNTTYJuGzt7JLdDrOUS', 0, NULL),
(20, 'ii.ivanov25', '$2y$10$wDkJ.DKm3FuMGFxXDLmKK.HpP2sUI0lfryD5EhFbE/5PpGZgdYp/O', 0, NULL),
(21, 'ii.ivanov26', '$2y$10$OifF9VbxCF/.NXaXdYLlqO73EYCsLVXfaPqYAQ0p.ASqTKkTSkbmu', 0, NULL),
(22, 'ii.ivanov001', '$2y$10$FhGDUNnG5NKIGftX9pRKXeDKC6po0WQM/ObkAYZBW2/QH6mHiy.CK', 0, 8),
(23, 'ee.litva3', '$2y$10$pqEkF6h9n4AjQt2SzoVRD.QNCvIAn1G6e.ywVtK9btWDFClMuDQv6', 0, 8),
(24, 'ee.litva1', '$2y$10$3g5kSGJjbiB7NnSDO3IKcO1aw3rH8y.YPd6Eh.Rd/xLR5hfBzZ7XW', 0, 8),
(25, 'ee.litva2', '$2y$10$4ajvUGO3EepMbD5Cwe3sp.tTYwitFWp804ATMpnlrUxhn1iDAe.H2', 0, 8),
(26, 'ee.litva11', '$2y$10$wJHaaQYC/3m7QKUAqsCG2e0mtO5Q4Pt2MFgW3NLFjyRXIS7f1dXUi', 0, 8),
(27, 'ee.litva55', '$2y$10$IzfnTtrtFnqEDYdpDcZu1.HHg5VaZFQm.vpXvELu.qcdp8L53B2dK', 0, 8),
(28, 'ee.litva', '$2y$10$74dfUZufYG3M6ycbcftTXuUEY/..2ZKleP2iNOx4nZSTnF.YKULui', 0, 8);
...
ALTER TABLE `privileges`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `work_position_2` (`work_position`),
